    ...
    <div className="w-full h-full px-8">
      ...
      <section className="relative max-w-[100rem] mx-auto">
        ...
        <div className="relative md:flex w-full justify-evenly items-center playfair-display-600 p-8 md:p-16 bg-stone-900 md:shadow-md md:shadow-black border-1 border-stone-950 rounded-3xl z-20">
          ...
          <div className="text-left z-20 flex flex-col gap-2 md:gap-8">
      ...
      {experience.length > 0 && <section className="relative my-[3rem] xl:mx-48">
        ...
        <div className="flex flex-col gap-12">
          {experience.map((e) => 
            <div key={e._id} className="flex flex-col gap-2 md:w-5xl max-w-screen mx-auto">
        ...
        <div className="md:w-5xl mx-auto my-2 z-10 relative">
